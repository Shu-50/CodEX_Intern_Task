...
//     return (
//         <div className="min-h-fit flex flex-col md:flex-row bg-black text-orange-500">
//             {/* Left: Joke Generator */}
//             <div className="flex-1 bg-gray-900 p-6 rounded-lg shadow-lg mx-4 mb-4 md:mb-0">
...
//                 </button>
//                 {joke && (
//                     <div className="mt-4 flex items-center justify-between bg-gray-800 p-4 rounded">
//                         <p>{joke}</p>
//                         <button
...
//             <div className="w-full md:w-1/4 bg-gray-800 p-3 rounded-lg shadow-lg mx-4">
